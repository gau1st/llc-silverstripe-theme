...
<% if Success %>
					...
					<form action="/contact/general-information/SendContactForm" method='post' id='contact_form' style="height:350px;overflow:hidden;font-size:0.85em;">  	
					<div style="width:466px;float:left;">
						<div style="width:466px;float:left;margin-bottom:8px;">	
						...
						<div style="width:466px;float:left;margin-bottom:8px;">	
							<div style="width:233px;float:left;margin-bottom:8px;">	
								<div style="width:100px;float:left;">
								Occupation :
								</div> 
							...
							<div style="width:223px;float:left;margin-bottom:8px;">	
						...
						<div style="width:466px;float:left;margin-bottom:8px;">	
							...
							<div>
								<textarea type='text' name='message' id='message' style="width:360px;height:50px"></textarea>	
							</div>  
							</div>
						</div>
